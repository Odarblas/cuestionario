...
[
    ...
    question: "106. Identifica el filtro aplicado a la imagen: <img src='beach.jpg' style='width:300px; filter: ;' alt='beach scene'/>",
image: 'images/pregunta106.jpg',
                    options: [
                        "opacity(30%)",
                        "sepia(100%)", 
                        "saturate(100%)",
        ...
        {
            question: "107. Identifica el filtro aplicado a la imagen: <img src='beach.jpg' style='width:300px; filter: ;' alt='beach scene'/>",
            image: 'images/pregunta107.jpg',
                options: [
                        "opacity(30%)",
                        "grayscale(100%)", 
                        "sepia(100%)",
        ...
        {
        question: "108. Identifica el filtro aplicado a la imagen: <img src='beach.jpg' style='width:300px; filter:  ;' alt='beach scene'/>",
        image: 'images/pregunta108.jpg',
                    options: [
                        "contrast(200%)",
                        "hue-rotate(90deg)", 
                        "saturate(100%)",
        ...
        {
             question: "109. Complete el marcado para mostrar una imagen con texto alternativo:",
                type: "code-selection",
                codeQuestion: {
                    template: `<[1] [2]="html5.gif" [3]="[4]" [5]="[6]">`,
                    options: [
        ...
        {
            question: "110. Crea una interfaz para una aplicación táctil. Durante las pruebas detectan que algunos toques activan varias áreas de entrada. ¿Qué situación causará este problema?",
            options: [
                "a) Las áreas de entrada definidas son demasiado pequeñas",
                "b) La pantalla táctil no está calibrada",
                "c) Las áreas de entrada están demasiado cerca",
                "d) Las áreas de entrada son semitransparentes"
            ],
            correct: 2,
        }
    ],
    ...
    [
        ...
        {
            question: "111.Complete el marcado para validar un número de teléfono de 10 dígitos sin símbolos, mostrando ceros inicialmente y sin almacenar valores:",
    type: "dropdown-completion",
    code: `<input id="phone" [1]="[0-9]{10}" [2]="0000000000" [3]>`,
    options: [
        {
            placeholder: "[1]",
            choices: ['pattern', 'type', 'validation', 'format'],
            correct: 0,
            explanation: "El atributo 'pattern' define una expresión regular para validar el valor de entrada"
        },
        {
            placeholder: "[2]",
            choices: ['placeholder', 'value', 'initial', 'display'],
            correct: 0,
            explanation: "'placeholder' muestra el texto cuando el campo está vacío sin afectar el valor real"
        },
        {
            placeholder: "[3]",
            choices: ['autocomplete="off"', 'novalidate', 'required', 'readonly'],
            correct: 0,
            explanation: "autocomplete='off' previene que el navegador almacene los valores ingresados"
        }
    ],
    explanation: "Solución completa: <input id='phone' pattern='[0-9]{10}' placeholder='0000000000' autocomplete='off'>"

        },

        {
            question: "112. ¿Qué dos afirmaciones describen correctamente las consultas multimedia? (Elige dos respuestas)",
    type: "multiple-correct",
    options: [
        {
            text: "a) Las consultas multimedia mejoran el rendimiento de una página web",
            correct: false
        },
        {
            text: "b) Las consultas multimedia admiten un diseño web con buena capacidad de respuesta",
            correct: true
        },
        {
            text: "c) Las consultas multimedia permiten aplicar diferentes reglas de CSS en distintas pantallas/puntos de interrupción",
            correct: true
        },
        {
            text: "d) Las consultas multimedia permiten aplicar diferentes reglas de CSS en distintos exploradores",
            correct: false
        }
    ],
    explanation: "Las respuestas correctas son b y c. Las consultas multimedia (@media) permiten crear diseños responsivos adaptándose a diferentes tamaños de pantalla, pero no mejoran directamente el rendimiento ni están relacionadas con aplicar estilos específicos para navegadores."
        },

        {
             question: "113. La variable ctx es el contexto de un objeto canvas de HTML5. ¿Qué dibuja el siguiente código?",
    code: "ctx.beginPath();\nctx.arc(100, 100, 50, 0, Math.PI, false);\nctx.stroke();",
    type: "code-multiple-choice",
    options: [
        "a) Una línea de un punto a otro",
        "b) Un cuadrado en el punto dado",
        "c) Un círculo en el punto dado",
        "d) Un semicírculo en el punto dado"
    ],
    correct: 3, // Índice de la respuesta correcta (d)
    explanation: "El método arc() con parámetros (x, y, radio, ánguloInicial, ánguloFinal) dibuja un arco. Al usar Math.PI (180 grados) como ángulo final, se dibuja un semicírculo."
        },

        {
            question: "114. Relaciona cada etapa del ciclo de vida de las aplicaciones con la tarea correspondiente",
    type: "dropdown-matching",
    leftItems: [
        { id: "planear", text: "Planear" },
        { id: "disenar", text: "Diseñar" },
        { id: "desarrollar", text: "Desarrollar" },
        { id: "probar", text: "Probar" },
        { id: "implementar", text: "Implementar" },
        { id: "mantener", text: "Mantener" }
    ],
    rightItems: [
        {
            id: "identificar",
            text: "Identificar la finalidad y audiencia del sitio web",
            correct: "planear"
        },
        {
            id: "definir",
            text: "Definir el diseño del sitio web",
            correct: "disenar"
        },
        {
            id: "crear",
            text: "Crear sitios web",
            correct: "desarrollar"
        },
        {
            id: "evaluar",
            text: "Evaluar la funcionalidad y el uso del sitio web",
            correct: "probar"
        },
        {
            id: "publicar",
            text: "Publicar el sitio web",
            correct: "implementar"
        },
        {
            id: "supervisar",
            text: "Supervisar y actualizar el sitio web",
            correct: "mantener"
        }
    ],
    explanation: "El ciclo de vida completo incluye: 1) Planificación (objetivos), 2) Diseño (UI/UX), 3) Desarrollo (construcción), 4) Pruebas (QA), 5) Implementación (deploy), 6) Mantenimiento (actualizaciones)."
        },
        {
             question: "115. Relaciona los atributos HTML con sus descripciones correspondientes",
    type: "dropdown-matching",
    leftItems: [
    ...
    rightItems: [
        {
            id: "desc1",
            text: "1) Establece una expresión regular con la que el valor debe coincidir",
            correct: "pattern"
        },
        {
            id: "desc2",
            text: "2) Muestra texto predeterminado hasta que el elemento recibe foco",
            correct: "placeholder"
        },
        {
            id: "desc3",
            text: "3) Establece elementos como obligatorios",
            correct: "required"
        },
        {
            id: "desc4",
            text: "4) Permite seleccionar múltiples archivos o correos electrónicos",
            correct: "multiple"
        }
    ],
    explanation: "Atributos clave: pattern (validación con regex), placeholder (texto guía), required (campo obligatorio), multiple (selección múltiple)."
    ...
    [
        {
            uestion: "116. ¿Qué tres eventos son válidos para el elemento HTML canvas?",
    type: "multiple-select", // Tipo especial para múltiples selecciones
    options: [
        { text: "clear", correct: true },
        { text: "cookie", correct: false },
        { text: "setItem", correct: false },
        { text: "write", correct: false },
        { text: "removeItem", correct: false }
    ],
    explanation: "Los eventos válidos para el elemento canvas incluyen clear y otros relacionados con el dibujo. Las opciones cookie, setItem y removeItem pertenecen a la API de almacenamiento, no al canvas."
        }
    ]
    ...
    container.className = 'multi-select-options';

    const instruction = document.createElement('p');
    instruction.className = 'multi-select-instruction';
    instruction.textContent = 'Selecciona las opciones correctas:';
    ...
    question.options.forEach((option, index) => {
        ...
        checkbox.id = `multi-${globalQuestionIndex}-${index}`;
        ...
        checkbox.addEventListener('change', () => {
            ...
            if (checked) {
                if (!userAnswers[globalQuestionIndex].includes(value)) {
                    userAnswers[globalQuestionIndex].push(value);
                }
            } else {
                userAnswers[globalQuestionIndex] = userAnswers[globalQuestionIndex].filter(v => v !== value);
            }
        ...
        label.textContent = option.text; // 🔧 ESTA ES LA LÍNEA CLAVE
    ...
    questionElement.appendChild(container);
                ...
                //pregunta 114
                else if (question.type === "dropdown-matching") {
    const container = document.createElement('div');
    container.className = 'dropdown-matching-container';
    ...
    question.rightItems.forEach(rightItem => {
        ...
        // Celda de tarea (derecha)
        const taskCell = document.createElement('td');
        taskCell.textContent = rightItem.text;
        ...
        dropdown.dataset.rightId = rightItem.id;
        
        // Opción por defecto
        const defaultOption = document.createElement('option');
        defaultOption.value = '';
        defaultOption.textContent = '-- Seleccione etapa --';
        defaultOption.disabled = true;
        defaultOption.selected = true;
        ...
        question.leftItems.forEach(leftItem => {
            const option = document.createElement('option');
            option.value = leftItem.id;
            option.textContent = leftItem.text;
            dropdown.appendChild(option);
        });
        
        // Restaurar selección previa
        if (userAnswers[globalQuestionIndex] && userAnswers[globalQuestionIndex][rightItem.id]) {
            dropdown.value = userAnswers[globalQuestionIndex][rightItem.id];
        }
        ...
        dropdown.addEventListener('change', () => {
            ...
            userAnswers[globalQuestionIndex][rightItem.id] = dropdown.value;
            updateProgressBar();
        });
        ...
        // Celda de etapa relacionada
        const matchCell = document.createElement('td');
        matchCell.className = 'match-display';
    ...
    questionElement.appendChild(container);
                ...
                //pregunta multiple 112
                else if (question.type === "multiple-correct") {
    const container = document.createElement('div');
    container.className = 'multiple-correct-container';
    ...
    optionsContainer.className = 'multiple-options';
    ...
    question.options.forEach((option, index) => {
        ...
        const checkbox = document.createElement('input');
        checkbox.type = 'checkbox';
        checkbox.id = `q${globalQuestionIndex}-opt${index}`;
        checkbox.dataset.correct = option.correct;
        
        if (userAnswers[globalQuestionIndex]?.includes(index)) {
            checkbox.checked = true;
        }
        ...
        checkbox.addEventListener('change', () => {
            ...
            if (userAnswers[globalQuestionIndex].length > 2) {
                ...
                document.getElementById(`q${globalQuestionIndex}-opt${oldestSelection}`).checked = false;
            }
        ...
        const label = document.createElement('label');
        label.htmlFor = `q${globalQuestionIndex}-opt${index}`;
